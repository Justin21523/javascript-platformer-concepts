...
export const WORLD = Object.freeze({
  segmentCountRange: [3, 5],
  segmentWidth: 48,
  segmentHeight: 24,
  eventChancePerSegment: 0.3,
  eventTrapChance: 0.15,
  eventTrialChance: 0.2,
});
...
export const VOID_MODE = Object.freeze({
  themes: [
    ...
    {
      name: "南瓜",
      wallpaperA: "rgba(40,10,0,0.9)",
      wallpaperB: "rgba(120,60,10,0.8)",
      colors: [
    ...
    {
      name: "星雲",
      wallpaperA: "rgba(10,0,30,0.9)",
      wallpaperB: "rgba(50,10,70,0.85)",
      colors: [
    ...
    {
      name: "幾何",
      wallpaperA: "rgba(5,5,5,0.92)",
      wallpaperB: "rgba(40,40,60,0.9)",
      colors: [
